...
while n > 0:
    ...
    if count_user1 < 1 or count_user1 > 28:
        ...
        if result:
            ...
            exit()
    h = 1
    count_user2 = int(input('How many candies would you like to have up to 28? '))
    if count_user2 < 1 or count_user2 > 28:
        print('User #2 has an incorrect number, try again. ')
    else:
        n = n - count_user2
        print('There', n, 'candies left')
        result = winner(h, n)
